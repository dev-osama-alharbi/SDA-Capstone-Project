...
//                .email("rellyTeam4@gmail.com")
                .username(APIVars.read().getEmail())
                .email(APIVars.read().getEmail())
                ...
                .userGroups(Collections.singletonList(
                        UserGroups.builder()
                                .id(5)
                                .name("Business Owner")
                                .subscriptionId("12e01972-a928-43f9-a20c-d8df7ff926e7")
                                .isDefault(true)
                                .build()
                ))
                ...
                .updated_by(41)
                .organizationId(1716287440101561L)
                .subscriptionId("12e01972-a928-43f9-a20c-d8df7ff926e7")
                .isActive(true)
