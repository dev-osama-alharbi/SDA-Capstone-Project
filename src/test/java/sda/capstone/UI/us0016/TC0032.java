...
//
//        wait.until(webDriver -> driver.findElement(By.xpath("//a[@href='#/user/66' and contains(text(),'New Team4 and 4')]")).isDisplayed());
//        bot.click(By.xpath("//a[@href='#/user/66' and contains(text(),'New Team4 and 4')]"));
//
...
//
//        bot.type(By.id("username"),"New UserName"+ Keys.ENTER);
//
